 ...
 *
 * We implement Openzeppelin's EIP712Upgradeable contract as a library and import it into the pool contract. This was done to reduce the size of the pool contract to satisfy the 24KB limit.
 */
library EIP712 {
