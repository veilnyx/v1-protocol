...
contract AaveAdaptorTest is PoolTest {
    ...
    address public constant WETH_AAVE_UNDERLYING =
        0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2; // Laby pool WETH is diff. than the one supported by Aave on chains other than Mainnets.

    uint256 public constant INITIAL_SUPPLY = 2 ether;
    uint256 public constant INITIAL_SUPPLY_USDC = 2e6;
    ...
    function setUp() external {
        ...
        // assetAddresses[0] = WETH_AAVE_UNDERLYING; // already added to the pool when running on mainnet as aave supports the same WETH on mainnet
